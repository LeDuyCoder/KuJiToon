                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: ComicInformationCardWidget(detailCommicEntity: widget.detailCommicEntity),
                            ),
                      ...
                      SizedBox(height: 40,),
                      ComicChaptersCardWidget(listLastChapters: listLastChapters, selectedSort: selectedSort, changeTypeShow: (String? value) {
                        setState(() {
