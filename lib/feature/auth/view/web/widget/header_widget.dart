    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("Đăng nhập để tiếp tục khám phá thế giới truyện tranh và theo dỗi những bộ truyện yêu thích của bạn", style: TextStyle(fontFamily: "EncodeSans", fontSize: 15, color: Colors.white.withAlpha(100)), textAlign: TextAlign.center,)
        ],
      ),
    );
  }
